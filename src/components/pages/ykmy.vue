<template>
    <ul class="pageBox">
        <li class="topLeft box">
            <div class="contBox">
			    <div class="charttitle"><span>|</span>{{$t('ylmy.tsfx')}}</div>
                <div class="contentBox">
                    <ul class="tsfxBoxTop">
                        <li v-for="(item, i) in tsfxList" :key="i">
                            <i :class="item.icon" :style="{color: item.color}"></i>
                            <p>{{$t('ylmy.'+item.name)}}</p>
                            <p class="value" :style="{color: item.color}">
                                <span>{{item.value}}</span>
                                <span>{{$t('ylmy.unit')}}</span>
                            </p>
                        </li>
                    </ul>
                    <div class="tsfxBoxBottom">
                        <span>{{$t('ylmy.tscll')}}</span>
